...
def get_weather(city: str) -> str:
    ...
    if not api_key:
        return "错误:未配置 SENIVERSE_API_KEY 环境变量"

    url = f"https://api.seniverse.com/v3/weather/daily.json?key={api_key}&location={city}&language=zh-Hans&unit=c&start=-1&days=5"
